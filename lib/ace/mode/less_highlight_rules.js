...
var LessHighlightRules = function() {
   ...
   var elements = lang.arrayToMap(
		("a|abbr|acronym|address|area|b|base|big|blockquote|body|br|button|" +
		"caption|cite|code|col|colgroup|dd|del|dfn|div|dl|dt|em|fieldset|" +
		"figure|form|frame|frameset|(h[1-6])|head|hr|html|i|iframe|img|input|" +
		"ins|kbd|label|legend|li|link|map|meta|noframes|noscript|object|ol|" +
		"optgroup|option|p|param|pre|q|samp|script|select|small|span|strike|" +
		"strong|style|sub|sup|table|tbody|td|textarea|tfoot|th|thead|title|" +
		"tr|tt|ul|var|header|section|footer|article|nav|aside|hgroup|time|mark"
		).split("|")
	);
    ...
    this.$rules = {
        ...
        },
		{
            ...
            token : function(value) {
				...
				else if (elements.hasOwnProperty(value.toLowerCase())) {
                    return "keyword.control.html.elements";
                }
				else {
                    return "text";
                }
